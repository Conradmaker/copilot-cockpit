...
PRD artifact format은 `.github/agents/artifacts/PRD-TEMPLATE.md`를, artifact index format은 `.github/agents/artifacts/ARTIFACTS-TEMPLATE.md`를 필요할 때 읽는다. subagent 호출관 관련한 packet schema는 `.github/instructions/subagent-invocation.instructions.md`를 따른다.
