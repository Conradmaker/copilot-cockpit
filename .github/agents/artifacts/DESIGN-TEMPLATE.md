...
- Wrapper or max-width rule: {container max-width, side-padding 등을 형용사 크기 묘사로 끝내지 않고 px 또는 vw로 잠근다}
...
- Hero or primary entry block: {headline structure, support copy, media or stat treatment — column span, vertical anchor, min-height 또는 viewport-height 의 구체적인 수치 단위로 잠근다}
