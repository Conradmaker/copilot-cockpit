...
이 스킬을 사용할 때는 README만 던지지 말고, 작업 방식까지 같이 제안한다.
...
1. 무엇이 바뀌었는지 요약
2. 기존 README에서 stale 섹션 지목
3. 수정된 문안 또는 패치 제안
4. 추가 확인이 필요한 source-of-truth 항목 정리

### 3. README 리뷰 요청

리뷰 응답은 아래 요소를 빠뜨리지 않는다.
