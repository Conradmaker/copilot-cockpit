...
- 모바일/태블릿/데스크톱 전환 시 반응형 전략, 입력 방식, safe area, 반응형 이미지가 적절한지 확인한다

→ 상세: [references/02-visual-checklist.md](references/02-visual-checklist.md)
→ 상세: [references/04-platform-adaptation.md](references/04-platform-adaptation.md) — 반응형 전략, 입력 방식 감지, safe area, 반응형 이미지, 실기기 테스트
...
| 파일 | 읽을 때 |
| --- | --- |
| [references/01-inspection-workflow.md](references/01-inspection-workflow.md) | 브라우저 캡처, re-verification loop 전체 워크플로를 실행할 때 |
| [references/02-visual-checklist.md](references/02-visual-checklist.md) | layout, responsive, accessibility, visual consistency 점검 기준이 필요할 때 |
| [references/03-framework-fixes.md](references/03-framework-fixes.md) | CSS, Tailwind, styled-components 등 framework별 fix 패턴이 필요할 때 |
| [references/04-platform-adaptation.md](references/04-platform-adaptation.md) | 반응형 전략, 입력 방식 감지, safe area, 반응형 이미지, 실기기 테스트 기준이 필요할 때 |

### 추천 로드 순서

- 전체 visual inspection: `01 → 02 → 03`
- 반응형 검수: `01 → 02 → 04`
- framework-specific fix: `03 → 01`
- 플랫폼 적응: `04 → 02 → 03`