---
name: ds-ui-patterns
description: "Modern UI layout patterns, section composition, dashboard design, SaaS landing structures, interactive sections, engaging design techniques, component design patterns, and presentation showcase. Use this skill when designing page layouts, structuring SaaS landing pages, building dashboards, composing hero sections, creating bento grids, designing navigation menus, structuring pricing pages, building analytics views, designing individual component patterns (pricing cards, tab bars, chips, footers, carousels, card overlays, login/signup forms), creating portfolio/SNS showcases, preparing client presentations, or deciding how to arrange sections and interactive elements on a page. Always consult this skill when making layout, section composition, or component-level design decisions, even if the user only asked to 'make a landing page' or 'build a dashboard'. For product-level UX flows and copy use ds-product-ux. For visual design foundations (color, typography, spacing) use ds-visual-design. For Tailwind CSS implementation use fe-tailwindcss. For component API design use fe-ui-element-components. Triggers on: layout pattern, page layout, landing page, hero section, bento grid, dashboard layout, sidebar, SaaS layout, section design, pricing page, pricing card, analytics page, navigation menu, popover, modal layout, interactive section, tab section, tab bar, card layout, grid layout, carousel, footer design, chip design, image overlay, card overlay, login form, signup form, showcase, portfolio presentation, mock-up, 레이아웃, 페이지 구성, 랜딩 페이지, 히어로 섹션, 벤토 그리드, 대시보드, 사이드바, SaaS 디자인, 섹션 구성, 가격 페이지, 가격표, 분석 페이지, 내비게이션, 탭 바, 카드 레이아웃, 그리드, 캐러셀, 푸터, 칩, 이미지 오버레이, 로그인 폼, 회원가입 폼, 쇼케이스, 포트폴리오, 목업."
---
