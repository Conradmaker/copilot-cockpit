 ...
 *
 * Demonstrates table definitions and relationships using Drizzle ORM
 * with PostgreSQL. Import these tables for type-safe queries.
 */
...
/**
 * Settings Table (JSON values, nullable userId = global settings)
 */
