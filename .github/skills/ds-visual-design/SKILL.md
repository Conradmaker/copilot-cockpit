...
- 순백색(#FFFFFF) 대신 아주 미세한 Off-white 캔버스를 활용해 눈의 피로를 줄이고 다른 요소와의 대비를 입체적으로 만든다
- 배경에 미세한 노이즈 텍스처를 추가하면 입체감과 전체적인 응집력(Cohesion)이 생기지만, 메인 요소를 방해하지 않도록 필요한 경우에 극히 미세하게 적용한다
