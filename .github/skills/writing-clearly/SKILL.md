...
description: "Clear, concise, and human-sounding prose for any language and any surface — documentation, commit messages, error messages, UI copy, reports, articles, or any text humans will read. Combines Strunk's composition principles with AI-pattern detection and removal (17 English patterns + 24 Korean patterns backed by KatFishNet linguistic research), voice injection, and a self-review quality gate. Use this skill when writing, editing, rewriting, or reviewing prose for clarity, concision, naturalness, or humanization, even if the user only says 'make this clearer', 'clean up the writing', 'this sounds robotic', 'humanize this', 'polish the copy', 'too wordy', or 'sounds like AI'. Always consult this skill for prose-quality work regardless of content type or platform. For content-type structure, format, and platform strategy use writing-content. For technical documentation patterns use writing-document. Triggers on: clear writing, concise writing, humanize, humanizer, AI writing, robotic text, polish prose, rewrite, edit copy, tone, voice, clarity, brevity, wordiness, hedging, filler, active voice, passive voice, AI patterns, 글쓰기, 명확하게, 간결하게, 자연스럽게, AI 느낌, 로봇 같은, 다듬어줘, 문장 다듬기, 글 수정, 글 다듬기, 어색해, 톤, 보이스, 휴머나이징."
---
