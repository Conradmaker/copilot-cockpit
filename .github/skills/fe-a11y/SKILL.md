---
name: fe-a11y
description: "Frontend web accessibility patterns for interactive UI, semantic HTML, keyboard support, accessible names, ARIA state, focus management, and screen reader behavior. Use this skill when building or reviewing buttons, forms, modals, dialogs, tabs, accordions, switches, dropdowns, inputs, or shared UI primitives, or when wiring roles, labels, focus, live regions, and keyboard interaction. Always consult this skill for any interactive or reusable component work, even if the user only asks to make a button, modal, form, tab, dropdown, wrapper, or design-system primitive and never mentions accessibility. For React component architecture use fe-react-patterns. For shared component API design use fe-ui-element-components. Triggers on: accessibility, a11y, ARIA, semantic HTML, keyboard navigation, screen reader, focus management, modal, dialog, form accessibility, dropdown, reusable primitive, 접근성, 키보드 네비게이션, 스크린리더, 포커스 관리, 시맨틱 HTML, 모달, 폼, 드롭다운, 재사용 컴포넌트."
