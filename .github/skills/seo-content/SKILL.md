---
name: seo-content
description: "SEO and GEO content optimization patterns for search intent, SERP analysis, keyword mapping, title tags, meta descriptions, Open Graph, Twitter cards, H1-H3 structure, featured snippets, FAQ design, internal linking, on-page scoring, content refresh, and AI-citable writing. Use this skill when the user asks to write or optimize SEO content, draft a keyword-targeted blog post, improve CTR, rewrite titles or meta tags, fix social preview tags, audit on-page SEO, align a page to search intent, add FAQ or comparison sections, refresh an old article, reduce keyword cannibalization, strengthen internal links, or make content more quotable by AI systems. Always consult this skill for search-intent-driven content work, even if the user only mentions a blog post, meta tag, FAQ, featured snippet, or GEO optimization. For crawlability, indexation, rendering, schema validation, Core Web Vitals, hreflang, or bot access use seo-technical. For generic content structure and voice use writing-content. Triggers on: seo content, on-page SEO, search intent, keyword strategy, title tag, meta description, featured snippet, FAQ, CTR, Open Graph, Twitter card, content refresh, cannibalization, GEO, AI citation, 콘텐츠 SEO, 온페이지 SEO, 검색 의도, 키워드 전략, 타이틀 태그, 메타 설명."
