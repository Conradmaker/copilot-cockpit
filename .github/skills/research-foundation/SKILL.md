...
description: "Foundational research methodology for evidence-first work grounded in local rules, existing patterns, official docs, and source-ladder verification before domain-specific execution. Use when asked to research first, verify assumptions, check local rules, confirm against docs, strengthen references, or avoid guesswork before planning, implementation, review, customization, or design decisions. Always consult for any task needing codebase context plus external verification, even if the user only says 'check docs first', 'don't guess', or 'verify this'. Hand off to research-product, research-design, research-content-source for domain-specific research after foundation pass. Triggers on: research-foundation, evidence pass, local rules, official docs, source ladder, verify assumptions, research first, 근거 우선, 자료조사, 로컬 규칙, 공식 문서, 추측하지 말고."
---
