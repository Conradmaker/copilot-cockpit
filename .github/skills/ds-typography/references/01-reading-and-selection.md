...
아래 목록은 금지 리스트가 아니다. context-first 원칙에 따라 Inter나 Roboto는 work tool이나 dashboard처럼 중립성이 필요한 surface에서 여전히 적합하다. 하지만 font에 개성이 필요하다고 판단되면 아래를 참고한다.
...
| Lato | Karla, Rubik, Albert Sans |
| Montserrat | Sora, Lexend, General Sans |
