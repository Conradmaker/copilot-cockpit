...
<button class="transition-colors duration-200 hover:bg-blue-700">
  ...
  <div class="transition-transform ease-out duration-300 hover:scale-105">
    ...
    <div class="transition-opacity delay-100 duration-300"></div>
  </div>
</button>
```
...
```html
<button class="transition-transform duration-100 active:scale-95">Click</button>
```
...
```html
<div class="data-[state=open]:animate-fade-in data-[state=closed]:animate-fade-out">Dialog</div>
```
...
<div class="transition-transform hover:translate-x-2">
  ...
  <div class="transition-all hover:w-64"></div>
</div>
```

GPU 가속되는 속성: `transform`, `opacity` 지양할 속성: `width`, `height`, `top`, `left`, `margin`, `padding`
