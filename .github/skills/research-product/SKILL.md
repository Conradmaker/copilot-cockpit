...
description: "Reference-led product discovery research for validating ideas, analyzing competition, sizing markets, and grounding product decisions in evidence. Use when researching product opportunities, competitive landscape, JTBD, Kano, value proposition, TAM/SAM/SOM, Porter's 5 Forces, or user interviews. Always consult this skill for discovery and validation work, even if the user only asks to 'validate an idea', 'analyze the market', 'research competitors', or 'should we build this'. For UI/UX references use research-design. For content sources use research-content-source. Triggers on: product discovery, market research, competitive analysis, JTBD, Kano, TAM, user interview, idea validation, opportunity assessment, 제품 조사, 시장 분석, 경쟁 분석, 사용자 인터뷰, 아이디어 검증."
---
